...
BEGIN
    ...
    END IF;
    INSERT INTO CHINOOK.CUSTOMER(CUSTOMERID,
                                 FIRSTNAME,
                                 LASTNAME,
                                 COMPANY,
                                 ADDRESS,
...
GRANT SELECT ANY TABLE TO questao3;
...
/* O insert não funcionou, alertando erro de privilégios insuficientes
   agora iremos executar a procedure */

CALL CHINOOK.INSERT_CUSTOMER(
    87247,
    'MARC RUFALO',
    'Dubois',
    NULL,
